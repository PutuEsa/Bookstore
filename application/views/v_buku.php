...
<table class="table table-hover table-stripped">
	...
	<thead>
		...
		<tr>
			...
			<td>No</td><td>kode_buku</td><td>Nama_buku</td>><td>Kategori</td><td>Penulis</td><td>Penerbit</td><td>Harga</td><td>Stock</td>
	...
	<tbody>
		...
		<tr>
			...
			<td><?php if($this->session->userdata('level')=="admin"){?> <a href="#ubah" data-toggle="modal" onclick="edit(<?=$bk->kode_buku?>)"  class="btn btn-warning">Ubah</a><?php }else{ 		echo ""; }?></td>
